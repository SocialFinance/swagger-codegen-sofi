...
public abstract class AbstractJavaCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    protected String clientName = "ApiClient";
    protected String consulName = "api-client";
    ...
    public AbstractJavaCodegen() {
        ...
        setReservedWordsLowerCase(
            Arrays.asList(
                ...
                "localVarContentType", "localVarAuthNames", "localReturnType", "ApiException",
    ...
    public String getSwaggerType(Property p) {
        ...
        if (typeMapping.containsKey(swaggerType)) {
            ...
            if (languageSpecificPrimitives.contains(type) || type.contains(".") ||
    ...
    public CodegenModel fromModel(String name, Model model, Map<String, Model> allDefinitions) {
        ...
        if(codegenModel.description != null) {
            codegenModel.imports.add(clientName);
        }
